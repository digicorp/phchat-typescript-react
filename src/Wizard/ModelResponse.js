...
class ModelResponse extends React.Component {
...
const connectedModelResponse = connect(mapStateToProps)(ModelResponse)
export { connectedModelResponse as ModelResponse }
